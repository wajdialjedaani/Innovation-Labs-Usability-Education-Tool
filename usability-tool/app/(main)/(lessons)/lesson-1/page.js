  ...
  return (
    <main>
      ...
      <p>
        ...
        see for a majority of the time spent on your platform
        <br /><br />
        In order for the user to make informed decisions in regards to the system, they will need to know the status of
        some aspects of the system.  These could be battery life, wi-fi connectivity, or even an indication that the
        system has acknowledged the user’s most recent request and is working to complete it.
        <br /><br />
