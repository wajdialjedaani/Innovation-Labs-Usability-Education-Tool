...
export function Heuristic4Text() {
  return (
    <div>
      ...
      <p>Consistency and compliance with established standards are important principles in interface design as a
        whole. The goal is to create a <strong>predictable</strong> and <strong>intuitive</strong> experience for users. This applies to
        everything within a system, including design elements, interactions, and behavior in general.
      </p>
      <p><strong>Consistent Design Elements:</strong> Ensure consistency in visual design elements throughout the interface. For
      ...
      <p><strong>Standardized Interactions:</strong> User interface designers should adopt the concept of standardized
      ...
      <p><strong>Consistency Across Devices and Platforms:</strong> Ensure consistency in user experience across different
      ...
      <p>A bad example of consistency accross devices and platforms would be Discord mobile and the Discord web app.
      ...
      <p className={styles.centerImage}><img src="/lessons/lesson4-graphics/discweb.png" alt="Discord Logo Button on web" /></p>
      <p>Above is the web app where the servers are below the direct messages.</p>
      <p className={styles.centerImage}><img src="/lessons/lesson4-graphics/discmobile.png" alt="Discord tabs on mobile" /></p>
      <p>Above is the mobile app which has tabs for servers and messages. Meaning that consistency across devices is not
        preserved.
      </p>
      <p><strong>Compliance with Accessibility Standards:</strong> Comply with accessibility standards to ensure everyone has
      ...
      <p>By prioritizing consistency and adhering to standards in interface design, designers can create a
        user experience that leads to user <strong>satisfaction</strong> and <strong>engagement</strong>. This heuristic serves as a
