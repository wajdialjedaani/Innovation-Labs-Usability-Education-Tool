...
export function Heuristic2Text() {
  return (
    <div>
      ...
      <p>“Matching between the system and the real world” entails creating interfaces that speak the user’s language 
...
<p>One important part of matching between the system and the real world is taking advantage of <strong>user familiarity</strong>. 
  Using language that users have seen before and are familiar with will allow them to instantly decipher its 
  meaning. Using <strong>symbols</strong> that users are familiar with in the real world can also convey the purpose that symbol 
  serves without having to directly tell the user.
</p>
<p className={styles.sideBySide}><img src="/lessons/lesson2-graphics/icons.png" alt="Icons that relate to real world objects"/>
...
<p>Connecting the system and the real world can also create <strong>intuitive navigation</strong>. Organizing information similarly 
...
<p>The system must also have <strong>consistent terminology</strong> used throughout. Differing terms that are swapped 
  ...
  Using terms that are the <strong>industry-standard</strong> can enhance user understanding by utilizing what a user is 
  previously familiar with.
</p>
<p>Providing users with appropriate <strong>feedback</strong> that matches their expectations for what should happen is 
...
<p className={styles.centerImage}><img src="/lessons/lesson2-graphics/hover.gif" alt="Button that changes color when clicked"/></p>
<p><strong>User testing</strong> and <strong>user feedback</strong> are crucial when it comes to understanding the users’ expectations. Without 
